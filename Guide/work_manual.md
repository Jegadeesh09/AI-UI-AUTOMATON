...
```bash
pytest backend/storage/scripts/test_<story_id>.py --alluredir=backend/storage/reports/<story_id>/allure-results
```
...
3. Click **Run Test**.
4. Once finished, click **View Detailed Allure Report** to see screenshots and step-by-step execution.
